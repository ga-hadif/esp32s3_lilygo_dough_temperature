 ...
 * Size: 82 px
 * Bpp: 4
 * Opts: --bpp 4 --size 82 --no-compress --font fa-regular-400.woff --range 61528 --format lvgl -o sent_icon.c
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap_send[] = {
    /* U+F058 "" */
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc_send[] = {
...
static const lv_font_fmt_txt_cmap_t cmaps_send[] =
{
    {
...
static  lv_font_fmt_txt_glyph_cache_t cache_send;
#endif

#if LVGL_VERSION_MAJOR >= 8
static const lv_font_fmt_txt_dsc_t font_dsc_send = {
#else
static lv_font_fmt_txt_dsc_t font_dsc = {
#endif
    .glyph_bitmap = glyph_bitmap_send,
    .glyph_dsc = glyph_dsc_send,
    .cmaps = cmaps_send,
    .kern_dsc = NULL,
    .kern_scale = 0,
    .cmap_num = 1,
...
#endif
    .dsc = &font_dsc_send,          /*The custom font data. Will be accessed by `get_glyph_bitmap/dsc` */
